...
public class LeaveClose extends OpMode {
    ...
    ElapsedTime declanTimer = new ElapsedTime();
    ...
    private Pose declanControlPoint = new Pose(25, 76, Math.toRadians(90));
    ...
    public void loop() {
        ...
        telemetry.addData("PathStaet", pathState);
        telemetry.addData("busy beaver?", follower.isBusy());
        telemetry.update();
    }
    ...
    public void buildPaths() {
        ...
        // ....... Launch 2
        goToDeclan = follower.pathBuilder()
                .addPath(new BezierLine(hitLeverPose, declanControlPoint))
                .setLinearHeadingInterpolation(hitLeverPose.getHeading(), declanControlPoint.getHeading())
                .build();
        launchPath2 = follower.pathBuilder()
                .addPath(new BezierCurve(  declanControlPoint, launchPose  ))
                .setLinearHeadingInterpolation(declanControlPoint.getHeading(), launchPose.getHeading())
                .build();
    ...
    public void autonomousPathUpdate() {
        ...
        switch (pathState) {
            ...
            case 5:
                if (!follower.isBusy()) {
                    follower.followPath(goToDeclan);
                    pathState = 6;
                }
                break;
            case 6:
